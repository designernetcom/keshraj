const form = document.querySelector("form.form-contact-2"),
	  statusTxt = form.querySelector("form.form-contact-2 .out-message");

form.onsubmit = (e) => {
	e.preventDefault();
	statusTxt.style.color = "#fd3001";
	statusTxt.style.display = "inline-block";
	statusTxt.innerText = "Sending your message...";
	form.classList.add("disabled");

	let xhr = new XMLHttpRequest();
	xhr.open("POST", "message-2.php", true);
	xhr.onload = () => {
