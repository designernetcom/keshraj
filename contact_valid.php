...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $mail->From = 'keshrajindustries@outlook.com';
        $mail->FromName ='keshrajindustries@outlook.com'; 
		$mail->addAddress('keshrajindustries@outlook.com'); 
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Keshraj Industries';
        $mail->isHTML(true);
